## CRC Logic Model
LogicModel_CRC <- list(c(3,4,5), c(3,4,10))   # ~3 & ~4 & ~5 | 3 & 4 & ~10  
...
## CRC S1 Logic Model
LogicModel_CRC_S1 <- list(c(4,8,9), c(2,6,8))      #4 & ~8 & ~9 | ~2 & ~6 & 8 
...
short.random.forest.any$Precision <- c(precision_CRC, precision_CRC_S1)
short.random.forest.any$Recall <- c(recall_CRC, recall_CRC_S1)
short.random.forest.any$Type <- c("CRC", "CRC Stage I")
short.random.forest.any$model <- c("~3 & ~4 & ~5 | 3 & 4 & ~10 ", "4 & ~8 & ~9 | ~2 & ~6 & 8")
