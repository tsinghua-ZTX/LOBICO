...
% Import data
data = importdata('~/LOBICO/data/short.random.forest.any/Bi-Normal-CRC_S1.txt');
Norm_CRC_data = data.data';
Y = importdata('~/LOBICO/data/short.random.forest.any/Normal-CRC_S1-biclass.txt');
